...
UI design exploration for [vm0](https://github.com/okou-ai/okou) GitHub issues.

## How it works

1. A GitHub issue describes a UI change request
2. The [`/ui-innovate`](https://github.com/okou-ai/okou/blob/main/.claude/skills/ui-innovate/skill.md) skill snapshots the current UI as a baseline using [freeze-dry](https://github.com/okou-ai/freeze-dry-bundle)
...
**https://okou-ai.github.io/ui-innovate/**
...
- **[freeze-dry](https://github.com/okou-ai/freeze-dry-bundle)** -- Captures live DOM as self-contained HTML (CSS inlined, images as data URIs)
